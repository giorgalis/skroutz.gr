...
namespace skroutz.gr
{
    ...
    public class FilterGroup : Request
    {
        ...
        public Task<Model.Categories.FilterGroups> ListFilterGroups(int categoryId)
        {
            ...
            return GetWebResultAsync(_builder.ToString()).ContinueWith((t) =>
                    JsonConvert.DeserializeObject<Model.Categories.FilterGroups>(t.Result.ToString()));
        }
    }
}
